        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Kolom Layanan */}
           <div>
            ...
            <ul className="space-y-2">
              ...
              <li>{/*<a href="#" className="hover:text-pink-400 transition">*/}Mobile Apps</li>
              <li>UI/UX Design</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/6282138199126" target="_blank" aria-label="WhatsApp" className="text-indigo-400 hover:text-white transition">
                <svg
